...
class Comunidad(models.Model):
    ...
    encargado = models.CharField(
        max_length=100, verbose_name="Encargado", null=False, blank=False
    )  # Nombre del encargado
    contacto_encargado = models.CharField(
        max_length=100, verbose_name="Contacto del encargado", null=False, blank=False
    )  # Contacto del encargado
    vertientes = models.PositiveIntegerField(
        default=0, null=True, blank=True
    )  # Número de vertientes
...
class Vertiente(models.Model):
    ...
    desc = models.CharField(
        max_length=250, verbose_name="Descripcion", null=True, blank=True
    )  # Descripción de la vertiente
    ubicación = models.CharField(
        max_length=200, verbose_name="Ubicación", null=True, blank=True
    )  # Ubicación de la vertiente
    ...
    comunidad = models.ForeignKey(
        Comunidad, on_delete=models.SET_NULL, null=True
...
class Kit(models.Model):
    ...
    mac = models.CharField(
        max_length=25, verbose_name="Direccion MAC", null=True, blank=True
    )  # Dirección MAC del kit
    ...
    modified_at = models.DateTimeField(
        auto_now=True
    )  # Fecha de última modificación del kit

    vertiente = models.ForeignKey(
        Vertiente, on_delete=models.SET_NULL, null=True
    )  # Relación con el modelo vertiente
...
class Datos(models.Model):
    ...
    kit = models.ForeignKey(
        Kit, on_delete=models.SET_NULL, null=True
    )  # Relación con el modelo kit
    vertiente = models.ForeignKey(
        Vertiente, on_delete=models.SET_NULL, null=True
    )  # Relación con el modelo vertiente
